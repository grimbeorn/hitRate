...
<head>
    <meta charset="UTF-8">
    <title>actualizacionDistribuidor</title>
...
<body>
    ...
    <!-- CUERPO -->
    <div class="container">
        <fieldset class="form-group"><legend>Busqueda de Distribuidor:</legend>
            Nombre del Distribuidor:
            <input class="form-control" type="text" id="busqueda" name="busqueda">  
        </fieldset>
        <form id="formActDist"><legend>Distribuidor:</legend>
    ...
    <script src="../js/actualizacionDistribuidor.js"></script>
</body>

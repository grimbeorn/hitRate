...
<head>
    <meta charset="UTF-8">
    <title>actualizacionUsuario</title>
    ...
    <link rel="stylesheet" href="../css/actualizacionUsuario.css" />
</head>
...
<body>
    ...
    <!--CUERPO-->
    <div class="container">
        <fieldset class="form-group"><legend>Busqueda del Usuario:</legend>
            Alias del Usuario:
            <input class="form-control" type="text" id="busqueda" name="busqueda">
        </fieldset>
        <fieldset class="form-group"><legend>Datos del Usuario:</legend>
        ...
        <button class="btn btn-primary" type="submit" id="btnActualizar" name="btnActualizar">Actualizar</button>
        <button class="btn btn-primary" type="submit" id="btnVolver" name="btnVolver">Volver</button>
    ...
    <script src="../js/actualizacionUsuario.js"></script>

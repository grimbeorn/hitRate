...
<head>
    ...
    <link rel="stylesheet" href="../css/altaDespacho.css" />
</head>
...
<body>
    ...
    <!-- CUERPO -->
    <div class="container">
        <form id="formDespacho"><legend>Datos del Despacho:</legend>        
            Nombre del despacho:
    ...
    <script src="../js/altaDespacho.js"></script>
</body>
